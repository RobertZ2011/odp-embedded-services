...
async fn task(spawner: Spawner) {
    ...
    static REFERENCED0: StaticCell<
        ReferencedStorage<1, GlobalRawMutex, ControllerType, DynamicSender<'_, psu::event::EventData>>,
    > = StaticCell::new();
    ...
    let event_receiver2 = ArrayPortEventReceivers::new(state2.create_interrupt_receiver());
