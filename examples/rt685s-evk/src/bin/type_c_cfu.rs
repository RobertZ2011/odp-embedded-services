...
type Wrapper<'a> = tps6699x_drv::Tps66994Wrapper<'a, NoopRawMutex, BusDevice<'a>>;
...
async fn main(spawner: Spawner) {
    ...
    let pd_controller = PD_CONTROLLER.get_or_init(|| {
        tps6699x_drv::tps66994(tps6699x, CONTROLLER0_ID, &PD_PORTS, [PORT0_PWR_ID, PORT1_PWR_ID], CONTROLLER0_CFU_ID).unwrap()
    });
